...
const Start = () => {
  return (
    <section className="w-full min-h-screen max-[599px]:px-6 flex flex-col items-center justify-center relative overflow-hidden">
      <h1 className="relative hubot-sans z-10 text-[2.8rem] md:text-7xl font-extrabold tracking-tight leading-tight text-center mb-6">
      ...
      <div className="flex gap-4 my-7 relative z-10 hubot-sans">
        <a
          href="#features"
      ...
      <footer className="absolute  bottom-8 left-0 right-0 flex justify-center max-[599px]:items-center max-[599px]:flex-col z-10">
